  ...
  const createNewTeam=()=>{
    createTeam({
      ...
      if(resp){
        ...
        toast("Team created Sucsessfully!!!")
      }
    })
  }
  return (
    <div className='px-6 md:px-17 my-16'>
        ...
        <div className='flex flex-col items-center mt-6'>
            ...
            <div className='mt-7 w-[40%]'>
                ...
                <Input placeholder='TeamName' className='mt-3' onChange={(e)=>SetTeamName(e.target.value)}/>
            </div>
            <Button className='bg-blue-500 mt-9 w-[30%] hover:bg-sky-700'
            disabled={!(teamName&&teamName?.length>0)} onClick={()=>createNewTeam()}
            > Create Team</Button>
        </div>
